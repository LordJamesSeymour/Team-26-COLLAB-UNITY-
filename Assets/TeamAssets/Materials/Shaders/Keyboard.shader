	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor = tex2D( _Keyboard_Platform_BaseMap, uv_Keyboard_Platform_BaseMap ).rgb;
...
ASEEND*/
//CHKSM=A7D1A0AA5427D51EB5401A045DA3DEF7ED874FEE