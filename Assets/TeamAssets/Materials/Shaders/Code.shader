	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color13 = IsGammaSpace() ? float4( 0, 1, 0.9703217, 0 ) : float4( 0, 1, 0.9338101, 0 );
				
				float2 texCoord19 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord19);
				

				float3 BaseColor = color13.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float3 Emission = ( color13.rgb * 10 );
				float Alpha = tex2D( _Testparticlealpha, panner17 ).r;
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				surfaceDescription.Alpha = tex2D( _Testparticlealpha, panner17 ).r;
				#if defined( _ALPHATEST_ON )
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;19;-640,64;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-496,384;Inherit;False;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0.2,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-256,128;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-480,-240;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,1,0.9703217,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;-208,16;Inherit;False;Constant;_Int0;Int 0;1;0;Create;True;0;0;0;False;0;False;10;0;False;0;0;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;48,144;Inherit;True;Property;_Testparticlealpha;Testparticlealpha;0;0;Create;True;0;0;0;False;0;False;-1;dd151ae6655b4a5428995cb8a61d5975;dd151ae6655b4a5428995cb8a61d5975;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=E439BC1569B19595697D9464D40E076E294F20D4