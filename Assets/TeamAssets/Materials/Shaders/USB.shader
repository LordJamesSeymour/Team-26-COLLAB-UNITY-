...
Shader "USB"
{
	Properties
	{
		_USB_BaseMap( "USB_BaseMap", 2D ) = "white" {}
		_USB_Emissive( "USB_Emissive", 2D ) = "white" {}
		_USB_MaskMap( "USB_MaskMap", 2D ) = "white" {}
		_USB_Normal( "USB_Normal", 2D ) = "bump" {}
	...
	LOD 0
		...
		Pass
		{
			...
			float4 _USB_BaseMap_ST;
			float4 _USB_Normal_ST;
			float4 _USB_MaskMap_ST;
			float4 _USB_Emissive_ST;
			float _AlphaClip;
			float _Cutoff;
			...
			sampler2D _USB_BaseMap;
			sampler2D _USB_Normal;
			sampler2D _USB_MaskMap;
			sampler2D _USB_Emissive;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_USB_BaseMap = input.ase_texcoord7.xy * _USB_BaseMap_ST.xy + _USB_BaseMap_ST.zw;
				
				float2 uv_USB_Normal = input.ase_texcoord7.xy * _USB_Normal_ST.xy + _USB_Normal_ST.zw;
				
				float2 uv_USB_MaskMap = input.ase_texcoord7.xy * _USB_MaskMap_ST.xy + _USB_MaskMap_ST.zw;
				float4 tex2DNode14 = tex2D( _USB_MaskMap, uv_USB_MaskMap );
				
				float2 uv_USB_Emissive = input.ase_texcoord7.xy * _USB_Emissive_ST.xy + _USB_Emissive_ST.zw;
				

				float3 BaseColor = tex2D( _USB_BaseMap, uv_USB_BaseMap ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _USB_Normal, uv_USB_Normal ), 1.0f );
				float3 Specular = 0.5;
				float Metallic = tex2DNode14.r;
				float Smoothness = 0.5;
				float Occlusion = tex2DNode14.g;
				float3 Emission = ( tex2D( _USB_Emissive, uv_USB_Emissive ) * 100 ).rgb;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_USB_BaseMap = input.ase_texcoord3.xy * _USB_BaseMap_ST.xy + _USB_BaseMap_ST.zw;
				
				float2 uv_USB_Emissive = input.ase_texcoord3.xy * _USB_Emissive_ST.xy + _USB_Emissive_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_USB_BaseMap = input.ase_texcoord1.xy * _USB_BaseMap_ST.xy + _USB_BaseMap_ST.zw;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_USB_Normal = input.ase_texcoord3.xy * _USB_Normal_ST.xy + _USB_Normal_ST.zw;
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-432,-32;Inherit;True;Property;_USB_Normal;USB_Normal;3;0;Create;True;0;0;0;False;0;False;-1;9f5847080ca3e2b439f886a06a1766ba;9f5847080ca3e2b439f886a06a1766ba;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-160,-192;Inherit;True;Property;_USB_BaseMap;USB_BaseMap;0;0;Create;True;0;0;0;False;0;False;-1;60458baac61243444a47e28516d060c7;60458baac61243444a47e28516d060c7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-80,256;Inherit;True;Property;_USB_Emissive;USB_Emissive;1;0;Create;True;0;0;0;False;0;False;-1;ce5c71ff5d0015646a33c4cf5650d75e;ce5c71ff5d0015646a33c4cf5650d75e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;-80,32;Inherit;True;Property;_USB_MaskMap;USB_MaskMap;2;0;Create;True;0;0;0;False;0;False;-1;5c121fbaa16f3ca4c9183f3dc07f3375;5c121fbaa16f3ca4c9183f3dc07f3375;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;352,272;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;INT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;280,409.5;Inherit;False;Constant;_Int0;Int 0;4;0;Create;True;0;0;0;False;0;False;100;0;False;0;0;0;1;INT;0
