	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				Gradient gradient15 = NewGradient( 0, 2, 2, float4( 1, 0, 0.5591402, 0 ), float4( 0.919745, 0, 1, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float Occlusion = 1;
				float3 Emission = SampleGradient( gradient15, texCoord14.x ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.GradientNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-416,-128;Inherit;False;0;2;2;1,0,0.5591402,0;0.919745,0,1,1;1,0;1,1;0;1;OBJECT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;294,-165.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D5D83B5313EA7837F27C3D438A4FCD9D7DC47EDD