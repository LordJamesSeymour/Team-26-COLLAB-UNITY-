...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		_Testparticlealpha1( "Testparticlealpha 1", 2D ) = "white" {}
	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 break19 = ( PositionWS * _Scale );
				float temp_output_17_0 = ( _TimeParameters.x * _ScrollSpeed );
				float4 appendResult14 = (float4(break19.x , ( break19.z + temp_output_17_0 ) , 0.0 , 0.0));
				float2 uv_Testparticlealpha1 = input.ase_texcoord7.xy * _Testparticlealpha1_ST.xy + _Testparticlealpha1_ST.zw;
				float clampResult36 = clamp(  (0.0 + ( NormalWS.y - 0.5 ) * ( 1.0 - 0.0 ) / ( 1.0 - 0.5 ) ) , 0.0 , 1.0 );
				float clampResult37 = clamp(  (0.0 + (  (1.0 + ( NormalWS.y - -1.0 ) * ( 0.0 - 1.0 ) / ( 0.0 - -1.0 ) ) - 0.5 ) * ( 1.0 - 0.0 ) / ( 1.0 - 0.5 ) ) , 0.0 , 1.0 );
				float clampResult39 = clamp(  (1.0 + ( ( clampResult36 + clampResult37 ) - 0.0 ) * ( 0.0 - 1.0 ) / ( 0.5 - 0.0 ) ) , 0.0 , 1.0 );
				float3 lerpResult34 = lerp( tex2D( _Testparticlealpha1, appendResult14.xy ).rgb , tex2D( _Testparticlealpha1, uv_Testparticlealpha1 ).rgb , clampResult39);
				float4 color42 = IsGammaSpace() ? float4( 0, 0.7042553, 1, 0 ) : float4( 0, 0.4540723, 1, 0 );
				

				float3 BaseColor = ( float4( lerpResult34 , 0.0 ) * color42 ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float temp_output_17_0 = ( _TimeParameters.x * _ScrollSpeed );
				float4 appendResult14 = (float4(break19.x , ( break19.z + temp_output_17_0 ) , 0.0 , 0.0));
				float2 uv_Testparticlealpha1 = input.ase_texcoord3.xy * _Testparticlealpha1_ST.xy + _Testparticlealpha1_ST.zw;
				float3 ase_normalWS = input.ase_texcoord4.xyz;
				float clampResult36 = clamp(  (0.0 + ( ase_normalWS.y - 0.5 ) * ( 1.0 - 0.0 ) / ( 1.0 - 0.5 ) ) , 0.0 , 1.0 );
				float clampResult37 = clamp(  (0.0 + (  (1.0 + ( ase_normalWS.y - -1.0 ) * ( 0.0 - 1.0 ) / ( 0.0 - -1.0 ) ) - 0.5 ) * ( 1.0 - 0.0 ) / ( 1.0 - 0.5 ) ) , 0.0 , 1.0 );
				float clampResult39 = clamp(  (1.0 + ( ( clampResult36 + clampResult37 ) - 0.0 ) * ( 0.0 - 1.0 ) / ( 0.5 - 0.0 ) ) , 0.0 , 1.0 );
				float3 lerpResult34 = lerp( tex2D( _Testparticlealpha1, appendResult14.xy ).rgb , tex2D( _Testparticlealpha1, uv_Testparticlealpha1 ).rgb , clampResult39);
				float4 color42 = IsGammaSpace() ? float4( 0, 0.7042553, 1, 0 ) : float4( 0, 0.4540723, 1, 0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float temp_output_17_0 = ( _TimeParameters.x * _ScrollSpeed );
				float4 appendResult14 = (float4(break19.x , ( break19.z + temp_output_17_0 ) , 0.0 , 0.0));
				float2 uv_Testparticlealpha1 = input.ase_texcoord1.xy * _Testparticlealpha1_ST.xy + _Testparticlealpha1_ST.zw;
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.WorldPosInputsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-1232,-304;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.BreakToComponentsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;19;-832,-256;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;18;-1008,-256;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.3;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleTimeNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-1056,-32;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-832,32;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-1248,-112;Inherit;False;Property;_Scale;Scale;0;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;21;-1136,160;Inherit;False;Property;_ScrollSpeed;ScrollSpeed;1;0;Create;True;0;0;0;False;0;False;-1;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;22;-1308.61,549.8798;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;23;-960,416;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;25;-960,704;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;0;False;3;FLOAT;1;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;27;-749.7302,747.088;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;-496,-160;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-640,-48;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-608,160;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;36;-712.6896,484.2499;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;37;-444.3461,810.2637;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;28;-544,464;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;38;-317.2361,586.6442;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.5;False;3;FLOAT;1;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;39;-45.3606,634.8988;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;34;320,160;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;30;-64,-32;Inherit;True;Property;_Testparticlealpha1;Testparticlealpha 1;2;0;Create;True;0;0;0;False;0;False;-1;1f481369de5eeff4c9fd2f99352bd246;1f481369de5eeff4c9fd2f99352bd246;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.DynamicAppendNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;32;-368,64;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;40;-96,224;Inherit;True;Property;_Testparticlealpha2;Testparticlealpha 1;2;0;Create;True;0;0;0;False;0;False;-1;1f481369de5eeff4c9fd2f99352bd246;1f481369de5eeff4c9fd2f99352bd246;True;0;False;white;Auto;False;Instance;30;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;42;384,544;Inherit;False;Constant;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;0,0.7042553,1,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;46;736,208;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B96AA8E0842E9041FD763FCC277B3908F5D23A23