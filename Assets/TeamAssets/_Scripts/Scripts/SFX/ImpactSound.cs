...
public class ImpactSound : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        AudioManager.instance.PlaySoundAtPoint(AudioManager.SoundType.CRASH, other.contacts[0].point, Mathf.Min(.5f, (other.relativeVelocity.magnitude - 10) / 80), .1f, 1, .1f, .2f);
    }
}
