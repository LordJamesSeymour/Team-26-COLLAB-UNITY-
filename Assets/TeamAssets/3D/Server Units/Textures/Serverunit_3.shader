...
Shader "Serverunit_3"
{
	Properties
	{
		_Server_Unit_03Default_Normal( "Server_Unit_03 - Default_Normal", 2D ) = "bump" {}
		_Server_Unit_03DefaultAO( "Server_Unit_03 - Default-AO", 2D ) = "white" {}
		_Server_Unit_03Default_MaskMap( "Server_Unit_03 - Default_MaskMap", 2D ) = "white" {}
		_Server_Unit_03Default_BaseMap( "Server_Unit_03 - Default_BaseMap", 2D ) = "white" {}
	...
	LOD 0
		...
		Pass
		{
			...
			float4 _Server_Unit_03Default_BaseMap_ST;
			float4 _Server_Unit_03Default_Normal_ST;
			float4 _Server_Unit_03Default_MaskMap_ST;
			float4 _Server_Unit_03DefaultAO_ST;
			float _AlphaClip;
			float _Cutoff;
			...
			sampler2D _Server_Unit_03Default_BaseMap;
			sampler2D _Server_Unit_03Default_Normal;
			sampler2D _Server_Unit_03Default_MaskMap;
			sampler2D _Server_Unit_03DefaultAO;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Server_Unit_03Default_BaseMap = input.ase_texcoord7.xy * _Server_Unit_03Default_BaseMap_ST.xy + _Server_Unit_03Default_BaseMap_ST.zw;
				
				float2 uv_Server_Unit_03Default_Normal = input.ase_texcoord7.xy * _Server_Unit_03Default_Normal_ST.xy + _Server_Unit_03Default_Normal_ST.zw;
				
				float2 uv_Server_Unit_03Default_MaskMap = input.ase_texcoord7.xy * _Server_Unit_03Default_MaskMap_ST.xy + _Server_Unit_03Default_MaskMap_ST.zw;
				float4 tex2DNode14 = tex2D( _Server_Unit_03Default_MaskMap, uv_Server_Unit_03Default_MaskMap );
				
				float2 uv_Server_Unit_03DefaultAO = input.ase_texcoord7.xy * _Server_Unit_03DefaultAO_ST.xy + _Server_Unit_03DefaultAO_ST.zw;
				

				float3 BaseColor = tex2D( _Server_Unit_03Default_BaseMap, uv_Server_Unit_03Default_BaseMap ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Server_Unit_03Default_Normal, uv_Server_Unit_03Default_Normal ), 1.0f );
				float3 Specular = 0.5;
				float Metallic = tex2DNode14.r;
				float Smoothness = tex2DNode14.g;
				float Occlusion = tex2D( _Server_Unit_03DefaultAO, uv_Server_Unit_03DefaultAO ).rgb.x;
				float3 Emission = 0;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_Server_Unit_03Default_BaseMap = input.ase_texcoord3.xy * _Server_Unit_03Default_BaseMap_ST.xy + _Server_Unit_03Default_BaseMap_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_Server_Unit_03Default_BaseMap = input.ase_texcoord1.xy * _Server_Unit_03Default_BaseMap_ST.xy + _Server_Unit_03Default_BaseMap_ST.zw;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_Server_Unit_03Default_Normal = input.ase_texcoord3.xy * _Server_Unit_03Default_Normal_ST.xy + _Server_Unit_03Default_Normal_ST.zw;
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-416,128;Inherit;True;Property;_Server_Unit_03Default_Normal;Server_Unit_03 - Default_Normal;0;0;Create;True;0;0;0;False;0;False;-1;e96862813e28886448d2d7b29b6fb698;e96862813e28886448d2d7b29b6fb698;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;-409,-287.5;Inherit;True;Property;_Server_Unit_03Default_MaskMap;Server_Unit_03 - Default_MaskMap;2;0;Create;True;0;0;0;False;0;False;-1;c91347ae76c6dc94f8218058876c1195;c91347ae76c6dc94f8218058876c1195;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-384,-64;Inherit;True;Property;_Server_Unit_03DefaultAO;Server_Unit_03 - Default-AO;1;0;Create;True;0;0;0;False;0;False;-1;f50ff2703625f924c99c7d50910d0b09;f50ff2703625f924c99c7d50910d0b09;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-384,-528;Inherit;True;Property;_Server_Unit_03Default_BaseMap;Server_Unit_03 - Default_BaseMap;3;0;Create;True;0;0;0;False;0;False;-1;8974553d5185e6a4aa7958858d664a10;8974553d5185e6a4aa7958858d664a10;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
